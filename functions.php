...
function trade_sphare_real_estate_setup() {
        ...
        register_nav_menus(
                array(
                        'primary' => __( 'Primary Menu', 'trade-sphare-real-estate-development' ),
                )
        );
}
...
/**
 * Load WordPress Color Picker in the Customizer.
 */
function trade_sphare_real_estate_customizer_controls_assets() {
